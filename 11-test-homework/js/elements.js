...
export const getPlanetsBackButtonEl =
 document.querySelector("#getPlanets-back");
export const getPlanetsNextButtonEl =
 document.querySelector("#getPlanets-next");
export const getPlanetsPageResultEl =
 document.querySelector("#getPlanets-page");
